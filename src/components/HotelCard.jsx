...
const HotelCard = ({room, index}) => {
    return(
     <Link to={'/rooms/' + room._id} onClick={() => scrollTo(0,0)} key={room._id} className="reative max-w-70 w-full rounded-xl overflow-hidden
        bg-white text-gray-500/90 shadow-[0px_4px_4px-rgba(0,0,0,0.5)]">
        <img src={room.images[0]} alt="" />
        
        {index % 2 === 0 &&<p className="px-3 py-1 absolute top-3 left-3 text-xs bg-white text-gray-800 font-meduim
        ...
        <div className="p-4 pt-5">
            ...
            <div className="flex items-center justify-between mt-4">
                ...
                <button className="px4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-50
